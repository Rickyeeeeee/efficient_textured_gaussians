...
def rasterize_to_pixels_packed_textured_gaussians(
    means2d: Tensor,
    ray_transforms: Tensor,
    colors: Tensor,
    opacities: Tensor,
    ...
    (
        ...
        colors.contiguous(),
        opacities.contiguous(),
        textures_packed.contiguous(),
        texture_dims.contiguous(),
        texture_offsets.contiguous(),
        normals.contiguous(),
        densify.contiguous(),
        backgrounds,
        masks,
...
class _RasterizeToPixelsPackedTexturedGaussians(torch.autograd.Function):
    """Rasterize gaussians Textured Gaussians"""
