...
python textured_gaussians_viewer.py \
    ...
    --data_factor 4 \
    --ckpt /workspace/work/A2TG/FixedPC_mcmc/MipNerf360/a2tg/pc50000/${scene}/ckpts/ckpt_29999.pt
    # --ckpt /workspace/work/A2TG_Correct/FixedPC_mcmc/MipNerf360/ntex_full/pc500000/${scene}/ckpts/ckpt_29999.pt
